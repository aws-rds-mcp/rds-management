...
async def describe_db_cluster_parameters(
    ...
    marker: Annotated[
        Optional[str], Field(description='Pagination token')
    ] = None,
    ...
    try:
        ...
        logger.info(f"Describing parameters for DB cluster parameter group {db_cluster_parameter_group_name}")
...
async def describe_db_instance_parameters(
    ...
    try:
        ...
        logger.info(f"Describing parameters for DB instance parameter group {db_parameter_group_name}")
...
async def describe_db_cluster_parameter_groups(
    ...
    try:
        ...
        response = await asyncio.to_thread(rds_client.describe_db_cluster_parameter_groups, **params)
