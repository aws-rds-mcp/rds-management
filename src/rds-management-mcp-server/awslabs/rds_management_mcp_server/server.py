...
mcp = FastMCP(
    ...
    instructions='Instructions for using this rds-management MCP server. This can be used by clients to improve the LLM''s understanding of available tools, resources, etc. It can be thought of like a ''hint'' to the model. For example, this information MAY be added to the system prompt. Important to be clear, direct, and detailed.',
    dependencies=[
        'pydantic',
        'loguru',
    ],
...
async def example_tool(
    ...
    """
    project_name = 'awslabs rds-management MCP Server'
    return (
