...
import pytest
from awslabs.rds_management_mcp_server.resources.db_cluster.list_clusters import (
    ClusterSummary,
    list_clusters,
)
...
class TestClusterSummary:
    ...
    def test_from_db_cluster_typedef(self):
        ...
        api_response: Any = {
            ...
            'DbClusterResourceId': 'cluster-ABCDEFGHIJKLMNOPQRSTUVWXYZ',  # pragma: allowlist secret
            'Status': 'available',
            'Engine': 'aurora-mysql',
        ...
        cluster = ClusterSummary.from_dict(api_response)
